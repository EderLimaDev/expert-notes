...
export const NewNoteCard = ({ onNoteCreated }: NewNoteCardProps) => {
    ...
    function handleStartRecording() {
        ...
        const isSpeechRecognitionAPIAvailable = 'SpeechRecgnition' in window
            || 'webkitSpeechRecognition' in window

        if (!isSpeechRecognitionAPIAvailable) {
            alert('Infelizmente seu navegador não suporta esta funcionalidade!')
            return
        }
        ...
        SpeechRecognition.maxAlternatives = 1   //maximo de alternativas para a palavra
        SpeechRecognition.interimResults = true //resultados em tempo real
                    ...
                    <form className='flex-1 flex flex-col'>
                        ...
                        {isRecording ? (
                            <button
                                ...
                                className='w-full bg-state-900 flex py-4 items-center justify-center gap-2 text-sm text-slate-300 outline-none font-medium hover:text-slate-100'>
